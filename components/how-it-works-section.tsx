  ...
  const steps = [
    {
      ...
      description: "Fill out our smart 4-step form with your startup concept, target market, and business model.",
      color: "from-cyan-400 to-blue-500",
    },
    {
      icon: Brain,
      title: "AI Multi-Agent Analysis",
      description: "5 specialized AI agents analyze market data, competitors, risks, and opportunities in real-time.",
    ...
    },
    {
      ...
      description:
        "Receive detailed validation with TAM/SAM/SOM, SWOT analysis, competitor insights, and business plan.",
    ...
    },
    {
      ...
      description:
        "Use actionable recommendations, export PDF reports, and collaborate with your team to build successfully.",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            From idea to validated business plan in 4 simple steps. Our AI does the research while you focus on
            building.
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            { number: "98%", label: "Validation Accuracy" },
            { number: "100+", label: "Data Sources" },
            { number: "5", label: "AI Agents Working" },
          ].map((stat, index) => (
