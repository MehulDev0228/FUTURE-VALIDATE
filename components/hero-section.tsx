    ...
    <div ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        >
          ...
          <span className="text-sm text-cyan-300">AI-Powered Startup Intelligence</span>
        ...
        >
          Get instant market analysis, competitor insights, and business validation powered by advanced AI. Stop
        ...
        >
          {[
            { icon: Target, text: "Market Validation" },
            { icon: Zap, text: "Instant Results" },
            { icon: Sparkles, text: "Research Analysis" },
          ].map((feature, index) => (
            <div
              key={index}
        ...
        >
          {[
            { number: "50K+", label: "Ideas Validated" },
            { number: "98%", label: "Accuracy Rate" },
            { number: "30sec", label: "Average Time" },
          ].map((stat, index) => (
