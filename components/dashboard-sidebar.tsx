...
import { Lightbulb, Users, Search, BarChart3, Settings, LogOut, Menu, X, Sparkles, Brain } from "lucide-react"
...
const sidebarItems = [
  ...
  { icon: Brain, label: "Nexus Research", href: "/dashboard/nexus" },
          ...
          <div className="p-6 border-b border-cyan-500/20">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full flex items-center justify-center">
                <span className="text-white font-semibold">{user?.email?.charAt(0).toUpperCase() || "U"}</span>
              </div>
              <div>
