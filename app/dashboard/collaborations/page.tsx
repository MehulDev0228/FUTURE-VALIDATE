      ...
      <main className="dashboard-main main-content">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="section-spacing"
          >
            <h2 className="text-2xl font-bold text-white mb-6">Collaboration Features</h2>
            <div className="card-grid grid-cols-1 md:grid-cols-3">
              <Card className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border-cyan-500/20 card-container">
                <CardContent className="card-content-full text-center">
                  ...
                  <p className="text-gray-400 text-sm">
                    Collaborate on startup ideas with your team members and share insights in real-time
                  </p>
                </CardContent>
              </Card>

              <Card className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/20 card-container">
                <CardContent className="card-content-full text-center">
                  <Users className="w-12 h-12 text-purple-400 mx-auto mb-4" />
                  <h3 className="text-white font-semibold mb-2">Team Feedback</h3>
                  <p className="text-gray-400 text-sm">
                    Get feedback and insights from your collaborators to improve your startup concepts
                  </p>
                </CardContent>
              </Card>

              <Card className="bg-gradient-to-br from-green-500/10 to-teal-500/10 border-green-500/20 card-container">
                <CardContent className="card-content-full text-center">
                  <CheckCircle className="w-12 h-12 text-green-400 mx-auto mb-4" />
                  <h3 className="text-white font-semibold mb-2">Joint Validation</h3>
                  <p className="text-gray-400 text-sm">Validate ideas together and make informed decisions as a team</p>
                </CardContent>
              </Card>
            </div>
          </motion.div>
