                  ...
                  <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:border-cyan-500/30 transition-all duration-300 h-full">
                    <CardContent className="card-content-full">
                      <div className="flex items-center justify-between mb-4">
                        <div
                          className={`w-12 h-12 bg-gradient-to-r ${metric.color} rounded-lg flex items-center justify-center flex-shrink-0`}
                        >
          ...
          >
            ...
            <Card className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border-cyan-500/20">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  Actionable insights to improve your startup success
                </CardDescription>
              </CardHeader>
              <CardContent className="p-8">
                <div className="card-grid grid-cols-1 md:grid-cols-3">
                  <div className="text-center card-container">
                    ...
                    <p className="text-xs text-cyan-400">Highest viability score this month</p>
                  </div>
                  <div className="text-center card-container">
                    <div className="text-4xl font-bold text-green-400 mb-4">📈</div>
                    <h3 className="text-lg font-semibold text-white mb-2">Best Growth Sector</h3>
                    <p className="text-sm text-gray-400 mb-2">EdTech sector showing 22% CAGR</p>
                    <p className="text-xs text-green-400">Fastest growing market segment</p>
                  </div>
                  <div className="text-center card-container">
                    ...
                    <p className="text-xs text-purple-400">Based on your validation history and market trends</p>
                  </div>
                </div>
              </CardContent>
            </Card>
